    ...
    private static RibbonTabViewModel BuildReferencesTab()
        => Tab(
            ...
            Group(
                ...
                2,
                RibbonGroupDockedCenterLayoutMode.Vertical,
                Item("table-contents", "Insert Table of Contents", FluentIconData.AppsList20Regular, 0, "table-contents", "TC", "Insert table of contents", layoutDock: RibbonItemLayoutDock.Left),
