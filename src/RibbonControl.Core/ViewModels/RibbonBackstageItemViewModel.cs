...
public class RibbonBackstageItemViewModel : RibbonObservableObject, IRibbonBackstageItemNode
{
    ...
    public RibbonBackstageItemViewModel()
    {
        SubItemsViewModel.CollectionChanged += (_, _) =>
        {
    ...
    public ObservableCollection<RibbonBackstageItemViewModel> SubItemsViewModel { get; } = [];

    IEnumerable<IRibbonBackstageItemNode>? IRibbonBackstageItemNode.SubItems => SubItemsViewModel;
    ...
    public bool HasSubItems => SubItemsViewModel.Count > 0;
